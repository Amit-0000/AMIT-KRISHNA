...
class OnboardingPage(BasePage):
    ...
    def click_get_started(self) -> None:
        self.tap(self.find_clickable(By.XPATH, GET_STARTED_XPATH))

    def use_case_step_shown(self) -> bool:
        return self.is_visible(*USE_CASE_RADIOGROUP)

    def select_curiosity_use_case(self) -> None:
        self.tap(self.find_clickable(By.XPATH, CURIOSITY_OPTION_XPATH))

    def click_continue(self) -> None:
        self.tap(self.find_clickable(By.XPATH, CONTINUE_XPATH))

    def privacy_step_shown(self) -> bool:
        return self.is_visible(*PRIVACY_LIST)

    def finish(self) -> None:
        self.tap(self.find_clickable(By.XPATH, FINISH_XPATH))
