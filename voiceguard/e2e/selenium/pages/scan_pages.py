...
Selectors are taken directly from the real components (same ones the Appium
suite's pages/scan_pages.py already verified):
...
class NewScanPage(BasePage):
    ...
    def analyze(self) -> None:
        self.click(self.find_clickable(*self.ANALYZE_BUTTON))
